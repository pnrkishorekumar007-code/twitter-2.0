...
const FIREBASE_ERROR_MESSAGES: Record<string, string> = {
  ...
  "auth/operation-not-allowed": "Email/Password sign-in is disabled. Enable it in Firebase Auth settings.",
...
export function getErrorMessage(
  ...
  if (typeof err === "object" && err !== null) {
    ...
    if (typeof e.code === "string" && FIREBASE_ERROR_MESSAGES[e.code]) {
